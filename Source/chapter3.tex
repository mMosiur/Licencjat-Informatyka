...
\begin{figure}[ht]
  \includegraphics[width=\textwidth]{DataSetCharacteristicsPlot}
...
\begin{figure}[ht]
  \includegraphics[width=\textwidth]{AttributeCharacteristicsPlot}
...
\begin{figure}[ht]
  \includegraphics[width=\textwidth]{AssociatedTasksPlot}
...
\begin{figure}[ht]
  \includegraphics[width=\textwidth]{AreaPlot}
...
\begin{figure}[ht]
  \includegraphics[width=\textwidth]{MissingValuesPlot}
