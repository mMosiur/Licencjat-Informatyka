...
Analiza charakterystyk zbiorów danych (rysunek \ref{fig:datasetcharacteristics}) pokazuje, że najbardziej użyteczne zbiory danych zawierają szeregi czasowe.
...
\begin{figure}[ht]
  \includegraphics[width=\textwidth]{DataSetCharacteristics.png}
  \caption{Analiza mediany i średniej liczby dziennych wyświetleń zbiorów danych względem ich charakterystyki}
...
\begin{figure}[ht]
  \includegraphics[width=\textwidth]{AttributeCharacteristics.png}
  \caption{Analiza mediany i średniej liczby dziennych wyświetleń zbiorów danych względem charakterystyki zawartych w nich danych}
...
\begin{figure}[ht]
  \includegraphics[width=\textwidth]{AssociatedTasks.png}
  \caption{Analiza mediany i średniej liczby dziennych wyświetleń zbiorów danych względem powiązanych z nimi zadań}
